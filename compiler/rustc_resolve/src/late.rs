...
use crate::late::lifetimes::{LifetimeBinderKind, LifetimeRib, LifetimeRibKind};
...
struct LateResolutionVisitor<'a, 'b, 'ast> {
    ...
    lifetime_uses: FxHashMap<LocalDefId, lifetimes::LifetimeUseSet>,
}
...
impl<'a> Resolver<'a> {
    pub(crate) fn late_resolve_crate(&mut self, krate: &Crate) {
        lifetimes::count_lifetimes(self, krate);
