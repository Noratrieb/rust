...
use crate::astconv::{AstConvBase, AstConvBaseExt};
...
impl<'tcx> AstConvBase<'tcx> for ItemCtxt<'tcx> {
...
fn fn_sig(tcx: TyCtxt<'_>, def_id: DefId) -> ty::PolyFnSig<'_> {
    ...
    match tcx.hir().get(hir_id) {
        ...
        TraitItem(hir::TraitItem {
            ...
            generics,
            ..
        }) => icx.ty_of_fn(hir_id, header.unsafety, header.abi, decl, Some(generics), None),
...
fn impl_trait_ref(tcx: TyCtxt<'_>, def_id: DefId) -> Option<ty::TraitRef<'_>> {
    ...
    match item.kind {
        hir::ItemKind::Impl(ref impl_) => impl_.of_trait.as_ref().map(|ast_trait_ref| {
            ...
            icx.instantiate_mono_trait_ref(
                ast_trait_ref,
                selfty,
...
fn compute_sig_of_foreign_fn_decl<'tcx>(
    ...
    let fty = ItemCtxt::new(tcx, def_id).ty_of_fn(hir_id, unsafety, abi, decl, None, None);
